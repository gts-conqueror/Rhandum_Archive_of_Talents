...
- A special Gunslinger variant appears: The Marksman (uses a sniper instead of pistols).
  Every 20 seconds a single Vengeance Mark  is applied to random monsters per merge rank of the marksman(mini bosses included).
...
-When mana ability is activated, Gunslinger enters Flow State for duration of ghost shot and can move around the board an extended number of times before reloading
